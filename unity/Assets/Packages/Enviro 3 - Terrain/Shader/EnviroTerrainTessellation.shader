	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_Control = inputMesh.ase_texcoord.xy * _Control_ST.xy + _Control_ST.zw;
				...
				float2 uv_Control1 = inputMesh.ase_texcoord.xy * _Control1_ST.xy + _Control1_ST.zw;
				...
				float2 uv_Control2 = inputMesh.ase_texcoord.xy * _Control2_ST.xy + _Control2_ST.zw;
				...
				float2 appendResult69 = (float2(inputMesh.positionOS.x , inputMesh.positionOS.z));
				...
				float2 texCoord232 = inputMesh.ase_texcoord.xy * temp_cast_20 + float2( 0,0 );
				...
				float3 DisplacementFinal282 = ( staticSwitch279 + ( inputMesh.normalOS * ( ( Height_Final267 * _DisplacementStrength ) * ( 1.0 - Puddle_Mask264 ) ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				#endif
				float localGetSplats43 = ( 0.0 );
				float2 uv_Control = inputMesh.uv0.xy * _Control_ST.xy + _Control_ST.zw;
				float4 SplatControl033 = SAMPLE_TEXTURE2D_LOD( _Control, sampler_Control, uv_Control, 0.0 );
				#if defined( _SPLATCOUNT__4 )
				float4 staticSwitch42 = SplatControl033;
				#elif defined( _SPLATCOUNT__8 )
				...
				float4 in043 = staticSwitch42;
				float4 _Vector1 = float4(0,0,0,0);
				float2 uv_Control1 = inputMesh.uv0.xy * _Control1_ST.xy + _Control1_ST.zw;
				float4 SplatControl135 = SAMPLE_TEXTURE2D_LOD( _Control1, sampler_Control1, uv_Control1, 0.0 );
				#if defined( _SPLATCOUNT__4 )
				float4 staticSwitch41 = _Vector1;
				#elif defined( _SPLATCOUNT__8 )
				...
				#endif
				float4 in143 = staticSwitch41;
				float2 uv_Control2 = inputMesh.uv0.xy * _Control2_ST.xy + _Control2_ST.zw;
				float4 SplatControl234 = SAMPLE_TEXTURE2D_LOD( _Control2, sampler_Control2, uv_Control2, 0.0 );
				#if defined( _SPLATCOUNT__4 )
				float4 staticSwitch40 = _Vector1;
				#elif defined( _SPLATCOUNT__8 )
				...
				float Height0248 = break245.z;
				float2 temp_cast_20 = (_SnowTiling).xx;
				float2 texCoord232 = inputMesh.uv0.xy * temp_cast_20 + float2( 0,0 );
				float2 temp_output_5_0_g1043 = texCoord232;
				float localStochasticTiling2_g1044 = ( 0.0 );
				float2 Input_UV145_g1044 = temp_output_5_0_g1043;
				float2 UV2_g1044 = Input_UV145_g1044;
