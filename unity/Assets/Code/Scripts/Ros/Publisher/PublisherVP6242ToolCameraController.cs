...
public class PublisherVP6242ToolCameraController : MonoBehaviour
{
    ...
    private void InitializeTextures()
    {
        ...
        {
            textureRGB = new Texture2D(cameraRGB.targetTexture.width, cameraRGB.targetTexture.height, TextureFormat.RGB24, false);
        }
        if (cameraDepth && cameraDepth.targetTexture)
        {
            textureDepth = new Texture2D(cameraDepth.targetTexture.width, cameraDepth.targetTexture.height, TextureFormat.RGBA32, false);
        }
    }
